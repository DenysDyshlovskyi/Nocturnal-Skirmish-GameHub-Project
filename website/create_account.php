...
<head>
    ...
    <title>GameHub & Nocturnal Skirmish - Create account</title>
    ...
    <div class="ca-container">
        ...
        <div class="ca-creation-form-container">
            ...
            <div class="ca-creation-form-additional-information-container">
                ...
                <input type="checkbox" required id="terms-checkbox">*I agree to GameHub's <a href="terms_and_conditions.txt" target="_blank" class="ca-terms-link">terms and conditions.</a>
